  ...
  return (
    <>
      ...
      >
        ...
        <TitleSection
          title="
        Ditch spreadsheets, unleash AI "
          subheading="Ask AI for critical financial data, inventory insights & intelligent forecasts on the go. Create transactions & learn how to use Deskera ERP with your AI assistant."
        />
        <div
          className="bg-white
          p-[2px]
